...
Route::post('/topic/store', 'bookController@store_topic')->middleware('verified')->name('store-topic');
Route::patch('/topic/update', 'bookController@update_topic')->middleware('verified')->name('update-topic');
Route::get('/topic/search', 'bookController@search_topic')->middleware('verified')->name('search-topic');
